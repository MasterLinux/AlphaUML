...
dojo.declare("ui.Language", null, {
    ...
    DIRECTORYNAME_DESCRIPTION: "",

    WARNING: "Warning: please keep attention:",
    REMOVE_FOLDER: "With this action you are also remove <br /> each other file in this folder permanently. Are <br /> you sure that you will remove this folder?",
    REMOVE_FILE: "",

    PROJECT_NAME_DESCRIPTION: "",
    PROJECT_ROOT_PATH_DESCRIPTION: "",
    CLASS_DESCRIPTION: "",

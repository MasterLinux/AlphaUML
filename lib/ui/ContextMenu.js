...
dojo.declare("ui.ContextMenu", ui.Object, {
        ...
        if(!this.isInit) {
            ...
            this.connect({
                ...
                method: function(event) {
                    if(event.target.id != this.htmlId) {
                    ...
                    if(!isParent && !isTitle && !isButton && !this.lock) {
                        this.lock = true;
                        this.close();
                    } else if(this.lock) {
                        //workarround ey
            ...
            this.subscribe({
                ...
                method: function(id, subMenu) {
                    if(this.htmlId != id && !subMenu && this.isOpen) {
                        this.close();
                    }
                }
            });
     ...
     */
    activate: function() {
        //if its already instantiate deactivate it
        if(this.isActivated) this.deactivate();
        
        //place menu into html
        this.place();
    ...
    open: function(x, y) {
        ...
        this.show(300, null, dojo.hitch(this, function() {
            this.isOpen = true;
     ...
     */
    close: function() {
        this.hide(300, null, dojo.hitch(this, function() {
            this.isOpen = false;
            this.deactivate();
        }));
    },

...
dojo.declare("ui.TextInput", ui.Object, {
    ...
    destroy: function(del) {
        if(this.buttons) dojo.forEach(this.buttons, function(btn) {
            btn.destroy(true);
        }); this.buttons = [];
    ...
    /**
     * add a specific button
     * @param icon string css class
     * @param title string button title
     * @param onClick function
     */
    addButton: function(icon, title, onClick) {
        if(!this.buttons) this.buttons = [];
        this.buttons.push(new ui.TextInputButton({
...
dojo.declare("ui.TextInputButton", ui.Object, {
    ...
    create: function() {
        ...
        //place button node
        dojo.place(
            '<div class="ddButton" id="' + this.htmlId + '"></div>',
            dojo.byId(this.placeAt)
        );
    ...
    setIcon: function(icon) {
        ...
        dojo.attr(node, "class", "ddButton icon " + this.icon);
    },
    ...
    setTitle: function(title) {
        ...
        dojo.attr(node, "class", "ddButton title");
    }
});

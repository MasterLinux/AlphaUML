...
dojo.declare("ui.Content", ui.Object, {
    ...
    setSize: function(width, height) {
        ...
        this.width = width || parentPos.w + "px";
        this.height = height || parentPos.h + "px";

        //set the containers size
        dojo.style(this.contentNode, "width", this.width);
        dojo.style(this.contentNode, "height", this.height);
    },
    ...
    place: function(frame) {
        ...
        if(frame) {
            //TODO deactivate current content
            //TODO activate it

 ...
 *
 */
dojo.provide("ui.dialog.AddRequiredInterface");
dojo.require("ui.classDiagram.Connector");
dojo.require("ui.Dialog");
dojo.require("ui.TextInput");

dojo.declare("ui.dialog.AddRequiredInterface", ui.Dialog, {
    ...
    create: function() {
        ...
        this.addTablePreview(
            '<div class="row">' +
                ...
                '<div class="association interface">' +
                    '<div class="west"></div>' +
                '</div>' +
    ...
    onApprove: function() {
        //get classes
        var interfaces = this.getClass(this.interfaces.getValue()); //TODO get interfaces
    ...
    subclassRow: function() {
        ...
        this.subclass = new ui.TextInput({
            ...
            onFocus: dojo.hitch(this, function() {
                ...
                //get each possible class
                var classes = this.getClasses(this.interfaces.value);
                //generate new class list

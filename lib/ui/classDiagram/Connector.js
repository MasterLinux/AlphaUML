...
dojo.declare("ui.classDiagram.Connector", ui.Object, {
    ...
    select: function(select, event) {
        ...
        if(select) {
            ...
            //open context menu
            if(this.menu && event) this.menu.open(event.clientX, event.clientY);
        }
        ...
        this.menu = new ui.ContextMenu({
            ...
            buttons: [
                ...
                },
                {
                    title: "Set Name",
                    onClick: dojo.hitch(this, function() {
                        this.l1.setName("Name");
                    })
                },
                {
                    title: dojo.hitch(this, function(){
                        var title = "Superclass";
                        if(this.p0Class) title = this.p0Class.nameInput.value;
                        return title;
                    }),
                    menu: {
                        title: "Edit",
                        buttons: [
                            {
                                ...
                                onClick: dojo.hitch(this, function() {
                                    //add role
                                    this.p0.setAssociationRole("Role", "public");
                                })
                            },
                            {
                                title: "Multiplicity",
                                menu: {
                                    title: "Set Multiplicity",
                                    buttons: [
                                        {
                                            title: "0..*",
                                            onClick: dojo.hitch(this, function() {
                                                //add multiplicity
                                                this.p0.setMultiplicity("0..*");
                                            })
                                        },
                                        {
                                            title: "1..2",
                ...
                },
                {
                    title: dojo.hitch(this, function(){
                        var title = "Subclass";
                        if(this.p3Class) title = this.p3Class.nameInput.value;
                        return title;
                    }),
                    menu: {
                        title: "Edit",
                        buttons: [
                            {
                                ...
                                onClick: dojo.hitch(this, function() {
                                    //add role
                                    this.p3.setAssociationRole("Role", "public");
                                })
                            },
                            {
                                title: "Multiplicity",

...
dojo.declare("ui.classDiagram.Connector", ui.Object, {
     ...
     *   direction: string point name "p0", "p1", "both" or "none",
    ...
    constructor: function(args) {
        ...
        this.direction = args.direction || "none";
        this.type = args.type;
    ...
    destroy: function(del) {
        ...
        //remove connector from diagram storage
        this.diagram.removeConnector(this.htmlId);
    ...
    setPosition: function(point) {
        ...
        if(dojo.byId(this[point].htmlId)) {
            ...
            if(!air) console.debug("security remove of connector");
            this.destroy(true);
        }
    },
 ...
 * connector for notes
 */
dojo.declare("ui.classDiagram.NoteConnector", ui.classDiagram.Connector, {
    isNoteConector: null,
    
    constructor: function(args) {
        args = args || {};
        this.type = "Association";
        this.isNoteConector = true;
    },

...
dojo.declare("ui.classDiagram.Attribute", ui.Object, {
    ...
    constructor: function(args) {
        ...
        this.modifierValue = args.modifier;
            ...
            this.editDialog = new ui.dialog.AddAttribute({
                ...
                onExecute: dojo.hitch(this, function(properties) {
                    ...
                    if(this.visibility) {
                        ...
                        if(properties.visibility) this.visibility.setValue(properties.visibility);
...
dojo.declare("ui.classDiagram.Visibility", ui.classDiagram.Text, {
    ...
    constructor: function(args) {
        args = args || {};
        this.value = args.visibility || "package";
    },
                ...
                buttons: [
                    {
                        title: "public",
                        onClick: dojo.hitch(this, function(event) {
                            this.component.addVisibility("public");
                        })
                    },
                    {
                        title: "protected",
                        onClick: dojo.hitch(this, function(event) {
                            this.component.addVisibility("protected");
                        })
                    },
                    {
                        title: "private",
                        onClick: dojo.hitch(this, function(event) {
                            this.component.addVisibility("private");
                        })
                    },
                    {
                        title: "package",
                        onClick: dojo.hitch(this, function(event) {
                            this.component.addVisibility("package");
                        })
                    }
                ]
            }

...
dojo.declare("ui.classDiagram.Class", ui.Object, {
     ...
     *   javaDoc: ui.classDiagram.JavaDoc
     * }
     * @param args
     */
    ...
    getJSON: function() {
        ...
        //get javadoc comment
        var noteX = null, noteY = null;
        var javaDocComment = null;
        for(var id in this.connectors) {
            var connector = this.connectors[id];
            if(connector.isNoteConector) {
                var _note = null;
                //get note
                if(connector.p0Class.isNote) {
                    _note = connector.p0Class;
                } else if(connector.p3Class.isNote) {
                    _note = connector.p3Class;
                }
                ...
                if(_note) {
                    ...
                    javaDocComment += _note.getComment();

                    //get the position of the first note
                    if(!noteX) noteX = _note.x;
                    if(!noteY) noteY = _note.y;
                }
            }
        }
        ...
        //set javadoc comment tag
        if(javaDocComment) {
            javaDoc["description"] = {
                "tag": "description",
                "description": javaDocComment
            };
        }
    ...
    /**
     * removes operation by its htmlId
     * @param id string htmlId
     */
     ...
     * @param id htmlId of the attribute
     */
...
dojo.declare("ui.classDiagram.Attribute", ui.Object, {
    ...
    destroy: function(del) {
        ...
        this.parent.removeAttribute(this.htmlId);
...
dojo.declare("ui.classDiagram.Operation", ui.Object, {
    ...
    destroy: function(del) {
        ...
        //remove from attribute list
        this.parent.removeOperation(this.htmlId);

...
dojo.declare("ui.classDiagram.Operation", ui.Object, {
    ...
    constructor: function(args) {
        ...
        this.propertyValue = args.property;
        this.nameValue = args.name;
        this.language = new ui.util.Language();
    ...
    getParameter: function() {
        ...
        for(var id in this.parameterList) {
            ...
            if(!paramList[paramName]) paramList[paramName] = {
                name: this.parameterList[id].name.value,
                dataType: this.parameterList[id].dataType.value,
                property: this.parameterList[id].property.value,
                multiplicity: this.parameterList[id].multiplicity.value,
                defaultValue: this.parameterList[id].defaultValue.value
            }

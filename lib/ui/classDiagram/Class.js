...
dojo.declare("ui.classDiagram.Attribute", ui.Object, {
    ...
    getJSON: function() {
        ...
        var arrayPos = (this.dataType && this.dataType.value) ? this.dataType.value.search(/\[.*\]/) : -1;
        var isArray = (arrayPos != -1) ? true : false;

        //check multiplicity. it has a higher priority then the array declaration
        var hasStarletSelector = (this.multiplicity && this.multiplicity.value && this.multiplicity.value.search(/\*/) != -1) ? true : false;
        //TODO allow 10, 100 or other, but 0 or 1
        var hasPointSelector = (this.multiplicity && this.multiplicity.value && this.multiplicity.value.search(/\.\.[2-9*]+/) != -1) ? true : false;
        if(this.multiplicity && this.multiplicity.value === "1") {
            isArray = false;
        } else if(hasStarletSelector || hasPointSelector) {
            isArray = true;
        }
        ...
        var genericStartPos = (this.dataType && this.dataType.value) ? this.dataType.value.search(/<.+>/) : -1;
        var genericEndPos = (this.dataType && this.dataType.value) ? this.dataType.value.search(/>/) : -1;
        var generic = null;
        ...
        //get data type
        var dataType = (this.dataType && this.dataType.value) ? this.dataType.value : "Object";
        if(genericStartPos != -1) {
        ...
        if(this.visibility && this.visibility.value == "+")
            visibility = "public";
        else if(this.visibility && this.visibility.value == "#")
...
dojo.declare("ui.classDiagram.Operation", ui.Object, {
    ...
    getJSON: function() {
        ...
        //checks whether param is an array
        var arrayPos = this.returnType.value.search(/\[.*\]/);
        var isArray = (arrayPos != -1) ? true : false;

        //search for generic declarations
        var genericStartPos = this.returnType ? this.returnType.value.search(/<.+>/) : -1;
        var genericEndPos = this.returnType ? this.returnType.value.search(/>/) : -1;
        var generic = null;
        ...
        //get data type
        var returnType = this.returnType ? this.returnType.value : "void";
        if(genericStartPos != -1) {

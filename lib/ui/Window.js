...
dojo.declare("ui.Window", ui.Object, {
    ...
    constructor: function(args) {
        ...
        //this.readConfig();
        config.read(dojo.hitch(this, function(cfg) {
            this.create(cfg);
        }));
    },
    ...
    create: function(cfg) {
        ...
        //setup program paths
        config.javac = cfg.javac;
        config.javadoc = cfg.javadoc;

        //get project root
        this.projectRoot = cfg.project;
    ...
    setSize: function(leftWidth, bottomHeight) {
        var stageWidth = this.stage.stageWidth - 2;

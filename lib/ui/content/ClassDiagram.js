...
dojo.declare("ui.content.ClassDiagram", ui.content.Scrollable, {
    ...
    generateJavaCode: function() {
        var diagramFrame = this.getGlobal("frame", this.tabBarId);
        if(diagramFrame) diagramFrame.showMessage(this.language.JAVA_GEN_START, true, "warning");
        ...
        var files = gen.generator(dojo.hitch(this, function(msg) {
            diagramFrame.showMessage(msg, true);
        }));
        ...
        if(frame) dojo.forEach(files, dojo.hitch(this, function(f, idx, arr) {
            if(diagramFrame) diagramFrame.showMessage(this.language.JAVA_GEN_OPEN_IN_TAB + f.fileName, true);
        ...
        //remove displayed process status
        if(diagramFrame) {
            diagramFrame.showMessage(this.language.JAVA_GEN_READY, true, "success");
            diagramFrame.removeMessage();
        }
    },
    ...
    generateDiagram: function() {
        ...
        if(air) {
            ...
            sources = [
                "ProjectExample/src/alphaumlsample/AlphaUMLSample.java",
                "ProjectExample/src/alphaumlsample/Convention.java",
                "ProjectExample/src/alphaumlsample/Gadget.java",
                "ProjectExample/src/alphaumlsample/Nerd.java"
            ]
        }

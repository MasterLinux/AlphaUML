...
dojo.declare("ui.Tab", ui.Object, {
    ...
    activate: function(publish) {
        ...
        if(!this.isActivated) {
            ...
            if(throwEvent) dojo.publish("TabActivated", [{
    ...
    deactivate: function(event) {
        ...
        var softDeactivate = event.softDeactivate;
    ...
    place: function(frame, index) {
        ...
        //set accent
        if(this.hasAccent) this.setAccent(true);
    ...
    /**
     * sets a special tab color for an accent
     * usually used to visualize a special state
     * @param activate boolean
     */
    setAccent: function(activate) {
        if(activate) {
            dojo.addClass(this.htmlId, "accent");
            this.hasAccent = true;
        }
        else {
            dojo.removeClass(this.htmlId, "accent");

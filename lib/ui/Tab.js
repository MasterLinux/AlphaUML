...
dojo.declare("ui.Tab", ui.Object, {
    ...
    register: function(frame) {
        this.placeAt = frame.tabsInnerId;
    ...
    place: function(frame, index) {
        ...
        if(typeof frame == "object") {
            ...
            if(this.frameId != frame.htmlId) {
                ...
                lastFrame.removeTab(this.htmlId);

                //refresh the tab index of the last frame
                lastFrame.setTabIndex();

                //activate the first tab
                if(!lastFrame.getTab(true)) {
                    lastFrame.getTab(0).activate();
                }

                //add this tab into the new frame
                frame.addTab(this, true, true);       
            }

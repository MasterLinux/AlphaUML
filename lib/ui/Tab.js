...
dojo.declare("ui.Tab", ui.Object, {
    ...
    create: function() {
        ...
        if(this.content) {
            ...
            //var parentPos = dojo.position(frame.contentNode, true);

            this.content.create();
            //this.content.setSize(parentPos.w, parentPos.h);
        }
    ...
    deactivate: function(event) {
        var isFrame = event.tabBarId == this.tabBarId;
        ...
        if(typeof frame == "object") {
            ...
            if(this.frameId != frame.htmlId) {
                ...
                if(!lastFrame.tabBar.getTab(true)) {
                    lastFrame.tabBar.getTab(0).activate();
                }
    ...
    getWidth: function() {
        ...
        //return dojo.position(node, true).w;
    }
});
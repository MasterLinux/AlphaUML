...
dojo.declare("lib.Config", ui.Object, {
    ...
    write: function(init, onSuccess) {
        ...
        try {
            ...
            if(mainNode) {
                dojo.place(
                    '<div class="InitError">Your OS does not allow to create the config file. <br /> It could be that you need administrative rights for your installation folder: <br /> ' + error + ' <br /> Please reinstall AlphaUML and choose another installation folder.</div>',
                    mainNode
                )
            }
        }

  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_JavaDocTag() {
        ...
        var result11 = parse_JavaDocParam();
        if (result11 !== null) {
          var result0 = result11;
        } else {
          var result10 = parse_JavaDocReturn();
          if (result10 !== null) {
            var result0 = result10;
          } else {
            var result9 = parse_JavaDocThrows();
            if (result9 !== null) {
              var result0 = result9;
            } else {
              var result8 = parse_JavaDocException();
              if (result8 !== null) {
                var result0 = result8;
              } else {
                var result7 = parse_JavaDocSince();
                if (result7 !== null) {
                  var result0 = result7;
                } else {
                  var result6 = parse_JavaDocAuthor();
                  if (result6 !== null) {
                    var result0 = result6;
                  } else {
                    var result5 = parse_JavaDocSee();
                    if (result5 !== null) {
                      var result0 = result5;
                    } else {
                      var result4 = parse_JavaDocUmlPos();
                      if (result4 !== null) {
                        var result0 = result4;
                      } else {
